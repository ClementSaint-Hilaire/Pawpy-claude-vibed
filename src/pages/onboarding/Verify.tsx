    ...
    <div className="flex flex-col h-full bg-bg-primary pt-16 pb-8 px-4 gap-6">
      ...
      <div className="flex-1 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Open Gmail */}
          <button className="flex items-center justify-center gap-3 w-full px-6 py-3 bg-bg-secondary rounded-xl active:opacity-70 transition-opacity">
            <GoogleIcon />
            <span className="text-sm font-normal text-text-primary">Ouvrir Gmail</span>
          </button>
