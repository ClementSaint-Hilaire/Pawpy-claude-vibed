...
const THIS_MONTH: Transaction[] = [
  { id: '1', name: 'Stéphane Laplace', date: 'Validé le 26/08/2025', amount: '60,43 €' },
  { id: '2', name: 'Marie Dupont', date: 'Validé le 24/08/2025', amount: '45,00 €' },
  { id: '3', name: 'Thomas Bernard', date: 'Validé le 20/08/2025', amount: '32,50 €' },
]

const LAST_MONTH: Transaction[] = [
  { id: '4', name: 'Stéphane Laplace', date: 'Validé le 18/07/2025', amount: '60,43 €' },
  { id: '5', name: 'Sophie Martin', date: 'Validé le 15/07/2025', amount: '78,00 €' },
  { id: '6', name: 'Lucas Petit', date: 'Validé le 12/07/2025', amount: '60,43 €' },
  { id: '7', name: 'Marie Dupont', date: 'Validé le 10/07/2025', amount: '60,43 €' },
  { id: '8', name: 'Thomas Bernard', date: 'Validé le 08/07/2025', amount: '60,43 €' },
  { id: '9', name: 'Stéphane Laplace', date: 'Validé le 05/07/2025', amount: '60,43 €' },
  { id: '10', name: 'Sophie Martin', date: 'Validé le 02/07/2025', amount: '60,43 €' },
]
...
function TransactionGroup({ label, transactions, hidden }: TransactionGroupProps) {
  return (
...
export default function OwnerProfilTransactions() {
  ...
  return (
    <div className="flex flex-col h-full bg-bg-primary pt-[62px] pb-[127px] px-4 gap-8 overflow-y-auto">
      ...
      {/* Transaction groups */}
      <TransactionGroup label="Ce mois-ci" transactions={THIS_MONTH} hidden={hidden} />
      <TransactionGroup label="Le mois dernier" transactions={LAST_MONTH} hidden={hidden} />
