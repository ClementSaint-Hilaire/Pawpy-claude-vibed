...
export default function SitterMessagerieConversation() {
  ...
  function handleSend() {
    ...
    sendMessage(id, { kind: 'text', from: 'sitter', text: text.trim() } satisfies TextMessage)
    setText('')
  }
    ...
    <div className="flex flex-col h-full bg-bg-primary relative">
      ...
      <div className="absolute top-0 left-0 right-0 pt-[62px] px-4 pb-3 flex items-center justify-between">
        ...
        <div className={`${glassStyle} px-4 h-[48px] flex items-center rounded-full`}>
          <span className="text-sm font-normal text-[#140800] tracking-[-0.14px]">{conversation.ownerName}</span>
        </div>
      </div>
